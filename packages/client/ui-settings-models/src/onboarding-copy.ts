...
/** The complete editable EZAI Desktop welcome notice in both supported GUI locales. */
export const WELCOME_NOTICE_COPY = {
  zh: {
    title: '欢迎使用 EZAI 桌面端',
    body: '基于 EZAI Harness 架构深度定制打造，无缝集成 DeepSeek、Kimi 等顶尖大模型协同矩阵。原生支持深度思考推理链、智能联网检索与全局快捷唤醒，所有对话数据本地加密存储，为您带来更纯粹、极速与安全的桌面级 AI 协同生产力体验。',
    continueLabel: '开始体验',
  },
  en: {
