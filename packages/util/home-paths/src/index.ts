/**
 * Shared filesystem path helpers for EZAIGC Harness user data.
 *
...
/** Directory name for the default EZAIGC Harness home under the OS home. */
export const DSH_HOME_DIR_NAME = '.dsh'

/** Stable user-facing display form for the default EZAIGC Harness home. */
export const DEFAULT_DSH_HOME_DISPLAY = `~/${DSH_HOME_DIR_NAME}`

/** Environment variable that overrides the default EZAIGC Harness home. */
...
/**
 * Resolve the default EZAIGC Harness home using Node's platform path rules.
...
/**
 * Resolve the single-root EZAIGC Harness home.
 *
...
/**
 * Join path segments onto the resolved EZAIGC Harness home.
