/**
 * Shared filesystem path helpers for EZAI Harness user data.
 *
...
/** Directory name for the default EZAI Harness home under the OS home. */
export const DSH_HOME_DIR_NAME = '.dsh'

/** Stable user-facing display form for the default EZAI Harness home. */
export const DEFAULT_DSH_HOME_DISPLAY = `~/${DSH_HOME_DIR_NAME}`

/** Environment variable that overrides the default EZAI Harness home. */
...
/**
 * Resolve the default EZAI Harness home using Node's platform path rules.
...
/**
 * Resolve the single-root EZAI Harness home.
 *
...
/**
 * Join path segments onto the resolved EZAI Harness home.
